      ...
      <main className="max-w-[60ch] mx-auto w-full p-8 flex-1 flex flex-col">
        <div className="space-y-12 pt-12">
          <section>
            ...
            <p className="text-gray-800 tracking-tight leading-snug mt-4">
              <span className="italic">contact</span>: <a href="mailto:akc2209@columbia.edu" className="text-blue-500 hover:text-blue-700 transition-colors duration-200">akc2209@columbia.edu</a>
            </p>
          </section>
          ...
          <footer className="mt-auto pt-12 flex justify-center gap-8 text-gray-400">
            <a href="https://twitter.com" className="hover:text-blue-500 transition-colors duration-200">twitter</a>
            <a href="https://www.linkedin.com/in/audrey-chan-2b6992247/" className="hover:text-blue-500 transition-colors duration-200">linkedin</a>
            <a href="https://substack.com" className="hover:text-blue-500 transition-colors duration-200">substack</a>
          </footer>
        </div>
      </main>
    </div>
